...
const GhanaMap = dynamic(() => import("../../components/GhanaMap"), {
  ssr: false,
  loading: () => <div style={{ minHeight: 390, display: "grid", placeItems: "center", color: "#BFD7EA" }}>Loading Ghana map…</div>,
});
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#07111F", color: "white", padding: "24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "minmax(0,2fr) minmax(260px,1fr)", gap: "24px" }}>
        <GhanaMap />
        <div style={{ background: "#0F1E33", borderRadius: "20px", padding: "20px" }}><h3>Live Intelligence Feed</h3><div style={{ marginTop: "18px" }}><p>🟢 System online</p><p>🌤 Weather monitoring active</p><p>🗺 Region selection enabled</p><p>📊 Waiting for election data</p></div></div>
      </div>
    </main>
  );
}
