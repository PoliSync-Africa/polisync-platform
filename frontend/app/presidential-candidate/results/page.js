...
export default function PresidentialCandidateResultsPage() {
  return (
    <ElectionAccessGate>
      <DashboardShell role="presidential_candidate" title="Live Election Results" subtitle="Real results received through the PoliSync election results pipeline" activeSection="results">
