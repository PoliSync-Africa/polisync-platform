export async function GET(request) {
  ...
  try {
    ...
    const target = `${apiBase}/api/electoral-geography/polling-stations${incoming.search}`;
    ...
    return Response.json({ success: false, message: error?.message || "Unable to connect to the polling stations service." }, { status: 502 });
  }
}
