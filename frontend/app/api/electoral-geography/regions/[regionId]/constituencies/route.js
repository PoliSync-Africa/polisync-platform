...
export async function GET(request, { params }) {
  try {
    ...
    const response = await fetch(`${API_BASE}/api/electoral-geography/regions/${encodeURIComponent(regionId)}/constituencies`, {
      method: "GET",
    ...
    catch { payload = { success: false, message: text || "Unable to load constituencies." }; }
