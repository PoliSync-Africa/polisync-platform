const API_DEFAULT = "https://polisync-platform.onrender.com";
const API_BASES = [process.env.NEXT_PUBLIC_API_URL, process.env.BACKEND_URL, API_DEFAULT, "https://polisync-platform-1.onrender.com"]
...
async function fetchRegions(base, authorization) {
  ...
  try {
    return await fetch(`${base}/api/electoral-geography/regions`, {
      method: "GET",
