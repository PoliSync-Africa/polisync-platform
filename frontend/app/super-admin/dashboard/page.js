...
.badge{width:64px;height:64px;display:grid;place-items:center;flex:0 0 64px;border:2px solid #f0cd61;border-radius:50%;background:linear-gradient(145deg,#075f2b,#043d1d);color:#f0cd61;font-weight:950;box-shadow:0 12px 28px rgba(0,0,0,.2)}
.stats{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:9px}
...
.stat i{margin-left:auto;color:#f0cd61;font-style:normal}
...
.destinations{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}
...
.arrow{position:absolute;right:18px;top:18px;color:#f0cd61;font-size:19px}
.principle{display:flex;align-items:center;gap:14px;margin-top:14px;padding:16px 18px;border:1px solid rgba(240,205,97,.2);border-radius:17px;background:rgba(0,0,0,.12)}
...
@media(max-width:1000px){.stats{grid-template-columns:repeat(3,minmax(0,1fr))}.destinations{grid-template-columns:1fr}}
@media(max-width:600px){.stats{grid-template-columns:repeat(2,minmax(0,1fr))}.hero{align-items:flex-start}.badge{width:48px;height:48px;flex-basis:48px}.stat{padding:9px}.stat-icon{width:32px;height:32px;flex-basis:32px}.stat strong{font-size:17px}.principle{align-items:flex-start}}
