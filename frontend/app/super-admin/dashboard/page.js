...
const CARDS = [
  ...
  ["✓", "Pending Approvals", "Review accounts, organizations and requests", "/super-admin/dashboard/operations", "approvals"],
  ["ϟ", "Quick Actions", "Access frequently used platform controls", "/super-admin/dashboard/operations", "quick"],
  ["▥", "Results Overview", "View and analyze submitted election results", "/super-admin/results/live", "results"],
  ["◇", "System Health", "Platform services, security and infrastructure", "/super-admin/dashboard/oversight", "health"],
  ["◉", "Results History", "All organizational election results and historical records", "/super-admin/results/history", "history"],
  ["☁", "Weather", "Live conditions for your current location", "/super-admin/dashboard/operations", "weather"],
];
...
const styles = `
.dashboard-home{min-height:100%;box-sizing:border-box;padding:clamp(16px,2.5vw,34px);background:radial-gradient(circle at 15% 10%,rgba(18,120,65,.26),transparent 28%),radial-gradient(circle at 88% 80%,rgba(240,205,97,.08),transparent 26%),#002d18;color:#fff;overflow-x:hidden}
...
.card-content{min-width:0;padding-right:28px}.card-content h2{margin:0 0 8px;color:#fff;font-size:clamp(25px,2.5vw,39px);line-height:1.12;font-weight:850;letter-spacing:-.7px;text-shadow:0 2px 6px rgba(0,0,0,.24)}
.card-content p{margin:0;max-width:360px;color:#fff;font-size:clamp(15px,1.5vw,20px);line-height:1.45;font-weight:450}
