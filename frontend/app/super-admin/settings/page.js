...
export default function SettingsPage() {
  ...
  const load = async () => {
    ...
    } catch (e) { setError(e.message || "Unable to load platform settings."); }
  ...
  return <DashboardShell role="super_admin" navigation={superAdminNavigation} activeSection="settings" title="Settings & Configuration" subtitle="Platform configuration and controls">
    <main className="page">
      <section className="hero">
        <div><div className="eyebrow">POLISYNC AFRICA • SUPER ADMIN</div><h1>Settings &amp; Configuration</h1><p>Control platform-wide behavior from one secure administration center.</p></div>
