...
export default function ParliamentaryCandidateResultsPage() {
  return (
    <ElectionAccessGate>
      <DashboardShell role="parliamentary_candidate" title="Live Election Results" subtitle="Constituency results received through the PoliSync election results pipeline" activeSection="results">
