  ...
  return (
    <div className="dashboard-pager">
      ...
      <style jsx>{`
        ...
        .step-icon { width:38px; height:38px; display:grid; place-items:center; flex:0 0 38px; border:1px solid rgba(240,205,97,.55); border-radius:11px; color:#f6d66d; font-size:18px; font-weight:900; }
        ...
        .pager-arrow { color:#f6d66d; font-size:20px; line-height:.8; font-weight:500; }
