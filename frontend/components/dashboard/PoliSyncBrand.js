...
const SEARCH_ROUTES = [
  ...
  ["AI Personal Assistant", "/ai-assistant"],
  ["Messages", "/messages"],
  ["Notifications", "/notifications"],
  ["Profile", "/profile"],
  ["Privacy & Security", "/settings/security"],
  ["Organization Profile", "/party/profile"],
  ["National Command", "/party/national"],
  ["Regional Administration", "/party/regions"],
  ["Constituencies", "/party/constituencies"],
  ["Polling Stations", "/party/polling-stations"],
  ["Candidates", "/party/candidates"],
  ["Polling Agents", "/party/polling-agents"],
  ["Live Results", "/party/results"],
  ["EC8 Results", "/party/ec8"],
  ["Communications", "/party/communications"],
  ["Calendar", "/party/calendar"],
