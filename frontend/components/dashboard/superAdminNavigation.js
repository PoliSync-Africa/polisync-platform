...
const superAdminNavigation = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/super-admin/polling-stations",
        icon: "⌖",
...

  {
    ...
    items: [
      {
        label: "Live Results",
        href: "/super-admin/results/live",
        icon: "◉",
        key: "live-results",
      },
      {
        label: "Result Verification",
        href: "/super-admin/results/verification",
        icon: "✓",
        key: "result-verification",
      },
      {
        label: "EC8 Verification",
        href: "/super-admin/results/ec8",
        icon: "▤",
        key: "ec8",
      },
      {
      ...
      {
        label: "AI Election Intelligence",
        href: "/super-admin/ai-election-intelligence",
        icon: "✦",
        key: "ai-election-intelligence",
      },
    ],
  },
