...
const organizationSchema = new mongoose.Schema({
  ...
  candidate: { userId: { type: mongoose.Schema.Types.ObjectId, ref: "User", default: null }, username: { type: String, default: null, trim: true }, fullName: { type: String, default: null, trim: true }, profilePhoto: { type: String, default: null }, registrationSource: { type: String, enum: ["polisync_user","official_source","manual",null], default: null }, biography: { type: String, default: "", trim: true }, campaignProfile: { type: String, default: "", trim: true } },
